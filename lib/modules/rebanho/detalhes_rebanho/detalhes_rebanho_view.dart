...
class DetalhesRebanhoView extends StatelessWidget {
              ...
              return Row(
                children: [
                  CircleAvatar(
                    backgroundColor: Get.isDarkMode ? Colors.white10 : Colors.black.withOpacity(0.05),
                    child: IconButton(
                      icon: Icon(Icons.edit_outlined, color: Colors.green[800], size: 20),
  ...
  InputDecoration _inputDecoration({IconData? prefixIcon, String? hintText, String? label}) {
            ...
            child: Column(
              children: [
                TextField(
                  ...
                  decoration: _inputDecoration(prefixIcon: Icons.search, hintText: "Buscar por ID, Apelido ou Raça..."),
                ),
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text("Nenhum animal encontrado para esta busca.", style: TextStyle(color: Colors.grey)),
                          ],
                        ),
                      )
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String vitalStatus = animal['vital_status'] ?? "Ativo";
                          final bool isInactive = vitalStatus != "Ativo";
                                ...
                                child: ColorFiltered(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: isInactive ? Colors.grey[300]! : (isSelected ? Colors.green[800]! : Colors.green[800]!.withOpacity(0.05)),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  ...
                                                  if (isInactive)
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        color: () {
                                                          if (vitalStatus == "Vendido") return Colors.blue[50];
                                                          if (vitalStatus == "Abatido") return Colors.orange[50];
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: TextStyle(
                                                          ...
                                                          fontWeight: FontWeight.bold, 
                                                          color: () {
                                                            if (vitalStatus == "Vendido") return Colors.blue[800];
                                                            if (vitalStatus == "Abatido") return Colors.orange[800];
                                              ...
                                              if (animal['name'] != null && animal['name'].toString().isNotEmpty)
                                                Text(
                                                  animal['name'],
                                                  style: TextStyle(color: isInactive ? Colors.grey : Colors.green[800], fontWeight: FontWeight.bold, fontSize: 14),
                                                  maxLines: 1,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
                                              ...
                                              if (isInactive) ...[
                                                ...
                                                Text(
                                                  "${vitalStatus == 'Óbito' ? 'Óbito em' : 'Saída em'}: ${animal['death_date'] != null ? DateFormat('dd/MM/yyyy').format(DateTime.parse(animal['death_date'])) : 'N/A'}",
                                                  style: TextStyle(
                                                    color: vitalStatus == 'Óbito' ? Colors.redAccent : Colors.blueGrey, 
                                                    fontSize: 10, 
                                                    fontWeight: FontWeight.bold
                                                  ),
                                                ),
